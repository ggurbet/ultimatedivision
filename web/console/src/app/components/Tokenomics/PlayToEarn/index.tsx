...
const PlayToEarn: React.FC = () =>
    <div className="play-to-earn">
        ...
        <p className="play-to-earn__description">
            ...
            <br /><br />
            The initial Play to Earn tokens will be distributed gradually at a decreasing pace among the players
            for competing in UD, and will be replaced by the proceeds of the game shop.
        </p>
    </div>;
