...
export const PAYMENT_AMOUNT = 150000000000;
export const TOKEN_PAYMENT_AMOUNT = 18000000000;
export const MAKE_OFFER_PAYMENT_AMOUNT = 13200000000;
export const CREATE_LOT_PAYMENT_AMOUNT = 17100000000;
export const APPROVE_TOKEN_PAYMENT_AMOUNT = 300000000;
export const APPROVE_NFT_PAYMENT_AMOUNT = 7500000000;
export const BUY_OFFER_PAYMENT_AMOUNT = 36000000000;
export const ACCEPT_OFFER_PAYMENT_AMOUNT = 30000000000;
export const MINT_ONE_PAYMENT_AMOUNT = 12300000000;
