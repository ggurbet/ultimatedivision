...
import club from '@static/images/capabilitiesPage/capabilities/club-icon.png';
import marketplace
    from '@static/images/capabilitiesPage/capabilities/marketplace-icon.png';
import weekly
    from '@static/images/capabilitiesPage/capabilities/weekly-icon.png';
